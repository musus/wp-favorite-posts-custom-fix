...
<div class="postbox">
    ...
    <div class="inside" style="display: block;">
        <img src="../wp-content/plugins/wp-favorite-posts-custom-fix/img/icon_coffee.png" alt="buy me a coffee" style=" margin: 5px; float:left;" />
        <p>Hi! This plugin fork from  <a href="http://nxsn.com?f=wpfp" target="_blank" title="Huseyin Berberoglu">Huseyin Berberoglu</a>'s WP Favorite Posts.</p>
        <p>He's been spending many hours to develop that plugin. <br />If you like and use this plugin, you can <strong>buy his a cup of coffee</strong>.</p>
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
            ...
            ">
            <input type="image" src="../wp-content/plugins/wp-favorite-posts-custom-fix/img/donate.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online.">
        </form>
